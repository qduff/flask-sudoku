...
from sudokutools.Sudoku.Board import *
from sudokutools.Sudoku.Solver import *
...
class Generator:
    ...
    def __init__(self):
        ...
        numbers  = "123456789456789123789123456214365897365897214897214365531642978642978531978531642"
